...
parser = ArgumentParser(description="Recogn script")
...
def proccess(cam: Camera, mode: str, showCam: bool) -> None:
    ...
    # Last printed info
    info = ''
    iterationsToAprove = 2 # TODO empirical. Old 5
    i = 0
    aproved = False
    ...
    while True:
        ...
        # Open Pass on Device
        if aproved:
            if sendDevice(sock, f'pass{cam.idx+1}') == MSGS[f'out{cam.idx+1}']: # TODO были траблы с индексом out0. На ноуте фронталка как 0-ая камера скорее всего
